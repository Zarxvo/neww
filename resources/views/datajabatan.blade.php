...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container">
            <a href="/tambahjabatan" button type="button" class="btn btn-success">Tambah Data Jabatan</a>
                ...
                <tbody>
                    ...
                    @foreach ($data as $index => $row)
                        <tr>
                            ...
                            <td>
                                <a href="/tampileditjabatan/{{ $row->id }}" class="btn btn-warning">Ubah</a>
...
@push('script')
    ...
    <script>
        $('.delete').click(function() {
            ...
            var jabatannama = $(this).attr('data-nama');

            swal({
                    title: "Yakin?",
                    text: "Kamu akan menghapus " + jabatannama + " ",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
